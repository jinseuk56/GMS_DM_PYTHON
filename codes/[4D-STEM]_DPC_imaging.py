...
if py_figure == "Y":
    ...
    ax2[0][0].axis("off")
    ax2[0][1].imshow(test.BF_stem, cmap="gray", origin="lower")
    ...
    ax2[1][0].axis("off")
    ax2[1][1].imshow(test.ADF_stem, cmap="gray", origin="lower")
    ax2[1][1].set_title("ADF-STEM image")
    ax2[1][1].axis("off")
    fig2.tight_layout()

    fig3, ax3 = plt.subplots(2, 2, figsize=(10, 10))
    ax3[0][0].imshow(test.BF_stem, cmap="afmhot", origin="lower")
    ax3[0][0].set_title("BF-STEM image")
    ax3[0][0].axis("off")
    ax3[0][1].imshow(test.E_field_y, cmap="gray", origin="lower")
    ax3[0][1].set_title("Electric field y_component")
    ax3[0][1].axis("off")
    ax3[1][0].imshow(test.E_field_x, cmap="gray", origin="lower")
    ax3[1][0].set_title("Electric field x_component")
    ax3[1][0].axis("off")
    ax3[1][1].imshow(test.E_mag, cmap="inferno", origin="lower")
    ...
    ax4[0][0].imshow(test.ADF_stem, cmap="gray", origin="lower")
    ...
    ax4[0][0].axis("off")
    ax4[0][1].axis("off")
    ax4[1][0].imshow(test.ADF_stem, cmap="gray", origin="lower")
    ax4[1][0].imshow(test.charge_density, cmap="RdBu_r")
    ax4[1][0].set_title("Charge density")
    ax4[1][0].axis("off")
    ax4[1][1].imshow(test.ADF_stem, cmap="gray", origin="lower")
