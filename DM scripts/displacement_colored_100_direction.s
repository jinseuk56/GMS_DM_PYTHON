...
for(i=0;i<A_row-1;i++){
	for(j=0;j<A_col-1;j++){		
		...
		setpixel(peak_point_y, round(x1), round(y1), white)
		setpixel(peak_point_y, round(x2), round(y2), white)
		setpixel(peak_point_y, round(x3), round(y3), white)
		setpixel(peak_point_y, round(x4), round(y4), white)
		setpixel(rgb_original_y, round(x1), round(y1), white)
		setpixel(rgb_original_y, round(x2), round(y2), white)
		setpixel(rgb_original_y, round(x3), round(y3), white)
		setpixel(rgb_original_y, round(x4), round(y4), white)
		
		setpixel(peak_point_x, round(x1), round(y1), white)
		setpixel(peak_point_x, round(x2), round(y2), white)
		setpixel(peak_point_x, round(x3), round(y3), white)
		setpixel(peak_point_x, round(x4), round(y4), white)
		setpixel(rgb_original_x, round(x1), round(y1), white)
		setpixel(rgb_original_x, round(x2), round(y2), white)
		setpixel(rgb_original_x, round(x3), round(y3), white)
		setpixel(rgb_original_x, round(x4), round(y4), white)
		...
		setpixel(peak_point_y, round(B_x), round(B_y), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(peak_point_y, round(B_x-1), round(B_y), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(peak_point_y, round(B_x+1), round(B_y), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(peak_point_y, round(B_x), round(B_y-1), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(peak_point_y, round(B_x-1), round(B_y-1), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(peak_point_y, round(B_x+1), round(B_y-1), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(peak_point_y, round(B_x), round(B_y+1), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(peak_point_y, round(B_x-1), round(B_y+1), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(peak_point_y, round(B_x+1), round(B_y+1), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(rgb_original_y, round(B_x), round(B_y), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(rgb_original_y, round(B_x-1), round(B_y), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(rgb_original_y, round(B_x+1), round(B_y), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(rgb_original_y, round(B_x), round(B_y-1), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(rgb_original_y, round(B_x-1), round(B_y-1), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(rgb_original_y, round(B_x+1), round(B_y-1), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(rgb_original_y, round(B_x), round(B_y+1), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(rgb_original_y, round(B_x-1), round(B_y+1), RGB(red*degree_y, 0, blue*(1-degree_y)))
		setpixel(rgb_original_y, round(B_x+1), round(B_y+1), RGB(red*degree_y, 0, blue*(1-degree_y)))
		...
		setpixel(peak_point_x, round(B_x), round(B_y), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(peak_point_x, round(B_x-1), round(B_y), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(peak_point_x, round(B_x+1), round(B_y), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(peak_point_x, round(B_x), round(B_y-1), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(peak_point_x, round(B_x-1), round(B_y-1), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(peak_point_x, round(B_x+1), round(B_y-1), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(peak_point_x, round(B_x), round(B_y+1), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(peak_point_x, round(B_x-1), round(B_y+1), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(peak_point_x, round(B_x+1), round(B_y+1), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(rgb_original_x, round(B_x), round(B_y), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(rgb_original_x, round(B_x-1), round(B_y), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(rgb_original_x, round(B_x+1), round(B_y), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(rgb_original_x, round(B_x), round(B_y-1), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(rgb_original_x, round(B_x-1), round(B_y-1), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(rgb_original_x, round(B_x+1), round(B_y-1), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(rgb_original_x, round(B_x), round(B_y+1), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(rgb_original_x, round(B_x-1), round(B_y+1), RGB(red*degree_x, 0, blue*(1-degree_x)))
		setpixel(rgb_original_x, round(B_x+1), round(B_y+1), RGB(red*degree_x, 0, blue*(1-degree_x)))
